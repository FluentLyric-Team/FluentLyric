...
namespace FluentLyric.Helpers.UI
{
    ...
    public class BackdropHelper
    {
        ...
        private bool TrySetAcrylicBackdrop()
        {
            if (DesktopAcrylicController.IsSupported())
            {
                ...
                Color BackgroundColor = IsDarkTheme() ? Color.FromArgb(255, 32, 32, 32) : Color.FromArgb(255, 243, 243, 243);
        ...
        private void Window_ThemeChanged(FrameworkElement sender, object args)
        {
            ...
            if (m_acrylicController != null)
            {
                Color BackgroundColor = IsDarkTheme(sender.ActualTheme) ? Color.FromArgb(255, 32, 32, 32) : Color.FromArgb(255, 243, 243, 243);
